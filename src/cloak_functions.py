"""
This file defines functions used for cloaking individual images or groups of images. Options include AFOG-style 
and PGD-style for attention and non-attention, as well as stickers and high-pass filters.
"""
...
# Cloaking with per-pixel attention, in the style of AFOG, optimized over a single image
...
# Cloak with vanilla stochastic gradient descent if we want to try that
...
# Cloak with traditional PGD optimized over a single image 
...
# Optimize with per-pixel attention AFOG style of a group of images with optional sticker and highpass filters
...
# Optimize in traditional PGD style over a group of images, with options for stickers and highpass mask
