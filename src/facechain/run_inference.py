...
input_img_path = '/home/hice1/zyahn3/scratch/FacePrivacy/src/facechain/poses/man/JG1.jpg'
pose_image = '/home/hice1/zyahn3/scratch/FacePrivacy/src/facechain/poses/man/JG2.jpg'
num_generate = 5
...
use_face_swap = True
pos_prompt = "looking to the side, darker lighting, bright light on one cheek, simple background, high-quality photo"
outputs = gen_portrait(use_face_swap, num_generate, base_model_idx, style_model_path, pos_prompt, neg_prompt, input_img_path, pose_image, multiplier_style)
