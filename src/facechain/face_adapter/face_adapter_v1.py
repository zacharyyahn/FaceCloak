...
if is_torch2_available():
    from facechain.face_adapter.face_attention_processor_v1 import FaceAttnProcessor2_0 as FaceAttnProcessor, AttnProcessor2_0 as AttnProcessor, CNAttnProcessor2_0 as CNAttnProcessor
else:
    from facechain.face_adapter.face_attention_processor_v1 import FaceAttnProcessor, AttnProcessor, CNAttnProcessor
from facechain.face_adapter import vit
from facechain.face_adapter import face_preprocess
    ...
    def set_adapter(self):
        ...
        for name in unet.attn_processors.keys():
            ...
            if cross_attention_dim is None:
                ...
                scale=1.0, ln=layer_norms[name]).to(self.device, dtype=torch.float32)
