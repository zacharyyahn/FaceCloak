...
from facechain.facechain.merge_lora import merge_lora, restore_lora
...
from facechain.face_adapter import FaceAdapter_v1, Face_Extracter_v1
...
class GenPortrait:
    ...
    def __init__(self):
        ...
        self.controlnet = ControlNetModel.from_pretrained(pose_model_path, torch_dtype=torch.float32)
